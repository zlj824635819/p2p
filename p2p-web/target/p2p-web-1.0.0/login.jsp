            ...
            <div class="login-cnt clearfix">
                <div class="login-form">
                    ...
                    <div class="login-box clearfix" style="z-index:10;">
                        <label>账号</label>
                        <input id="phone" name="phone" type="text" class="input_text" placeholder="请输入11位手机号码" onblur="checkPhone();" maxlength="11"/>
                    </div>

                    <div class="login-box clearfix" style="z-index:8; padding-bottom:0px;">
                        <label>密码</label>
                        <input id="loginPassword" name="loginPassword" type="password" placeholder="请输入登录密码" onblur="checkLoginPassword();" class="input_text" maxlength="16"/>
                    </div>
